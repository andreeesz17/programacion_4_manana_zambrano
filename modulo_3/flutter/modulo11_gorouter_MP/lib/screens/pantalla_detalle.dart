...
class PantallaDetalle extends StatelessWidget {
  final String      id;
  final MuelleSSH? muelle; // puede venir por extras

  const PantallaDetalle({super.key, required this.id, this.muelle});

  @override
  Widget build(BuildContext context) {
    // Si no viene por extras, buscar en la lista simulada
    final srv = muelle ??
        muelleesSimulados.where((s) => s.id == id).firstOrNull;
    ...
    return Scaffold(
      ...
      body: srv == null
          ? Center(child: Text('Muelle $id no encontrado'))
          : Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(children: [
                    ...
                    FilledButton.icon(
                      onPressed: () => context.push('/muellees/${srv.id}/logs'),
