      ...
      body: ListView(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: Text(
              'grua-goliath-terminal-norte → sin respuesta',
              textAlign:
        ...
        Wrap(
          ...
          Wrap(
            ...
            children: [
              ...
              IconButton(
                ...
                color: Colors.indigo,
                iconSize: 28,
                tooltip: 'Detiene todas las grúas'
              ),
            ],
          ),
          const SizedBox(height: 12),
          ...
          Card(
            ...
            child: ListTile(
              ...
              title: const Text('Contenedor MX-01'),
              subtitle: const Text('Inspección de aduanas completada. Se detectaron variaciones menores en el manifiesto, pero no representan riesgo para el embarque.'),
          ...
          Card(
            ...
            child: ListTile(
              ...
              title: const Text('remolcador-principal'),
              subtitle: const Text('sin respuesta · Muelle B'),
          ...
          Card(
            child: SwitchListTile(
              value: false,
              onChanged: (_) {},
              title: const Text('Modo tormenta'),
            ),
          ),
          const Divider(height: 32),
          ...
          Wrap(
            ...
            runSpacing: 8,
            children: [
              const Chip(label: Text('Carga Pesada')),
              const Chip(label: Text('Refrigerado')),
              const Chip(label: Text('Peligroso')),
              const Chip(label: Text('Aduana')),
              const Chip(
              ...
              FilterChip(
                ...
                label: const Text('Escaneado'),
                selected: false,
                onSelected: (_) {},
                padding: const EdgeInsets.all(8),
              ),
              ActionChip(
                label: const Text('Ver manifiesto'),
