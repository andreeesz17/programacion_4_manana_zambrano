...
void main() => runApp(MaterialApp(
  ...
  home: switch (paso) {
    ...
    4 => const Scaffold(
      body: Center(
        child: ServicioEstado(nombre: 'Contenedor MX-01'),
      ),
    ),
    5 => Scaffold(                               // Paso 3b
      body: Center(
        child: Column(
          ...
          children: [
            ContadorLimitado(
              ...
              textoBoton: 'Intentar',
              onLimite: () => debugPrint('¡Carga bloqueada!'),
            ),
            const SizedBox(height: 40),
            ContadorLimitado(
              etiqueta: 'Barcos en muelle',
              limite:   10,
    ...
    6 => Scaffold(                              // Paso 4
      appBar: AppBar(title: const Text('Tiempo en muelle')),
...
class Saludo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return const SelectableText(
      'Sistema Central de Control Portuario inicializado. Monitoreo de cargueros, contenedores y grúas activado y en funcionamiento.',
      style: TextStyle(
        fontSize: 32,
