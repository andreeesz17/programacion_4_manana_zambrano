...
class _PantallaPaso5State extends ConsumerState<PantallaPaso5> {
  ...
  Widget _buildBody(CatalogoState estado) {
    ...
    return _buildLista(estado.productos, showLoader: estado.cargando);
  }

  Widget _buildLista(List<Producto> productos, {required bool showLoader}) => ListView.builder(
    controller: _scrollController,
    padding: const EdgeInsets.all(8),
    itemCount: productos.length + (showLoader ? 1 : 0),
