...
// │  2  Paso 2  NotifierProvider + lista de muellees              │
...
class AppMonitoreo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: switch (paso) {
        1 => const _Paso1(),
        2 => const PantallaMuelles(),
        3 => const PantallaBusqueda(),
        4 => const PantallaMetricas(),
        5 => const PantallaCentroControl(),
        _ => Scaffold(
...
class _Paso1 extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Muelles conectados')),
      body: Center(
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            Text('$count', style: Theme.of(context).textTheme.displayLarge),
            const Text('muellees activos'),
          ],
        ),
      ),
